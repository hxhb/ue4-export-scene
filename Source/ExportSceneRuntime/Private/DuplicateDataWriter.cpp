 ...
 */
FDuplicateDataWriterEx::FDuplicateDataWriterEx( FUObjectAnnotationSparse<FDuplicatedObject,false>& InDuplicatedObjects, FLargeMemoryData& InObjectData, UObject* SourceObject,
 ...
 * I/O function
 */
FArchive& FDuplicateDataWriterEx::operator<<(FName& N)
{
...
FArchive& FDuplicateDataWriterEx::operator<<(UObject*& Object)
{
	if (Object &&
...
FArchive& FDuplicateDataWriterEx::operator<<(FLazyObjectPtr& LazyObjectPtr)
{
...
void FDuplicateDataWriterEx::AddDuplicate(UObject* SourceObject, UObject* DupObject)
{
 ...
 */
UObject* FDuplicateDataWriterEx::GetDuplicatedObject(UObject* Object, bool bCreateIfMissing)
{
